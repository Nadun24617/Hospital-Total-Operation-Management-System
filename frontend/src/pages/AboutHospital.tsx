    ...
    <div className="min-h-screen bg-muted">
      ...
      <div className="max-w-5xl mx-auto py-10 px-4 space-y-10">
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl text-blue-800">ABC Hospital</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-gray-700">ABC Hospital is a multi-specialty healthcare institution dedicated to providing high-quality, patient-centered medical services through advanced technology and professional medical care.</p>
            <p className="text-gray-700">Established in 2012, ABC Hospital has become a trusted healthcare provider, delivering reliable and efficient medical services while maintaining high standards of safety, ethics, and patient satisfaction.</p>
          </CardContent>
        </Card>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="rounded-2xl">
            <CardHeader>
              <CardTitle className="text-xl text-blue-700">Our Mission</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="rounded-2xl">
            <CardHeader>
              <CardTitle className="text-xl text-blue-700">Our Vision</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-xl text-blue-700">Our Services</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-xl text-blue-700">Our Medical Team</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-xl text-blue-700">Hospital Facilities</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-xl text-blue-700">Hospital Performance Overview (Sample Data)</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-xl text-blue-700">Operating Hours</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-xl text-blue-700">Why Choose ABC Hospital</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
